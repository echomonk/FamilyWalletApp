  ...
  const { network } = useNetwork()
    ...
    return (
      <div className="flex flex-col w-full justify-center items-center my-5 p-3 blue-glassmorphism">
          {/* { account.isAdmin ?
            <span
              className="flex flex-grow w-full justify-center items-center my-5 p-3 rounded-full bg-orange-500 hover:bg-orange-600 text-white text-base font-semibold">
              Welcome Admin
            </span> :
            <>
            </>
        ...
        <div className="my-2 w-full rounded-full p-2 outline-none bg-transparent text-white border-none text-sm white-glassmorphism">
           { network.data }
        </div>
        <div className="my-2 w-full rounded-full p-2 outline-none bg-transparent text-white border-none text-sm white-glassmorphism">
           { network.data }
